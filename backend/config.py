...
{"type": "todo" | "note" , "content": "content here, remove any information about date or deadline and put in the date field instead", "status": "status if applicable, otherwise empty string", "date": "deadline or date if applicable in ISO 8601 (YYYY-MM-DDTHH:mm:ss.sssZ), otherwise empty string", "priority_rank": 0-5}
"""
